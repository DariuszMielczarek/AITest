...
class AStarHanoiAgent(HanoiAgent):
    def search_agent(self, show_visuals: bool = True, heuristic_function=None):
        self._frontier.append(HanoiState(self._hanoi_start_state, 0, heuristic_function(self._hanoi_start_state)))
        while len(self._frontier) != 0:
            ...
            self._check_possible_moves(state.hanoi, state.previous_cost, heuristic_function)
